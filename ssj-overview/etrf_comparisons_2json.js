var select_water_year = function(water_year){
  if(water_year == 2015){
    ...
    var disalexi_eto = ee.Image("users/ucd-cws-ee-data/ssj-delta-cu/ssj-disalexi/disalexi_monthly/eto_2015_v2");

    var methods={
      itrc:{image:ee.Image("users/ucd-cws-ee-data/ssj-delta-cu/ssj-itrc-metric/itrc_et_wy2015_v2-0-1"), eto:spatial_cimis_eto},
      disalexi:{image:ee.Image("users/ucd-cws-ee-data/ssj-delta-cu/ssj-disalexi/disalexi_et_wy2015_v2-1-1"), eto:disalexi_eto},
    ...
    var disalexi_eto = ee.Image("users/ucd-cws-ee-data/ssj-delta-cu/ssj-disalexi/disalexi_monthly/eto_2016_v2");
